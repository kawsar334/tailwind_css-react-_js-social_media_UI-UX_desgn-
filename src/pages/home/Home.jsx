      ...
      <div className=' flex justify-between items-start '>
        ...
        <div className='w-full md:w-[70%] overflow-y-auto h-[100vh] no_scrollbar '>
          <div className='w-2/3  m-auto flex justify-center items-center gap-4  my-3'>
            <button className={`btn btn-sm border-[#1877F2]  ml-2 ${openPost ? "bg-[#1877F2] text-[white]" :"bg-[white] text-[#1877F2] hover:bg-[white]"}`} onClick={showNewsFeed}>Newsfeed</button>
            <button className={`btn btn-sm border-[#1877F2]  ml-2 ${openStory ? "bg-[#1877F2] text-[white]" :"bg-[white] text-[#1877F2] hover:bg-[white]"}`} onClick={showStrory}>Story</button>
            <button className={`btn btn-sm border-[#1877F2]  ml-2 ${openFriendList ? "bg-[#1877F2] text-[white]" :"bg-[white] text-[#1877F2] hover:bg-[white]"}`} onClick={showAddFriend}>Add Friend</button>
