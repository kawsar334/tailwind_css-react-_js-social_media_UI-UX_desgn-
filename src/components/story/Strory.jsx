...
const Story = ({posts}) => {
    ...
    return (
            ...
            {/* <img src="/images/mee.png" alt="loading..." className=' w-[150px] h-[200px] object-cover rounded ' /> */}
                {posts.map((item) => (
                    <div key={item.idMeal} className='w-[70px] h-[70px] md:w-[100px] lg:w-[150px] md:h-[150px] lg:h-[200px]  relative md:rounded m-1 cursor-pointer flex justify-center items-center rounded-full overflow-hidden  border-[3px] border-[white]'>
                        <div className='w-full h-full' onClick={() => handleImage(item?.strMealThumb)}>
