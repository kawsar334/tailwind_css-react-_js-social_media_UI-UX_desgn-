export const arabic = {
  ...
  "Welcome to Handy!": "ي 6 صباحًا مارت",
  ...
  "Register as seller and open shop in Handy to start your business":
    "سجل كبائع ومتجر مفتوح في handy لبدء عملك",
  ...
  eBusiness: "Ebusiness",
  Solution: "حل",
  "Handy is a Laravel and Flutter Framework-based multi-vendor food, grocery, eCommerce, parcel, and pharmacy delivery system. It has six modules to cover all your business functionality.":
    "handy عبارة عن نظام توصيل متعدد البائعين ، والبقالة ، والتجارة الإلكترونية ، والتجارة الإلكترونية ، والتجارة الإلكترونية ، والطرز ، ونظام توصيل الصيدلة ، handy عبارة عن نظام توصيل الصيدلة ، وتجارة الإلكترون ، والتجارة الإلكترونية ، والطرد ، ونظام توصيل الصيدلة. لديها ست وحدات لتغطية جميع وظائف عملك.",
  ...
  "They create a account on Handy using your code and place their first order":
    "يقومون بإنشاء حساب على handy باستخدام الكود الخاص بك ويضعون طلبهم الأول",
